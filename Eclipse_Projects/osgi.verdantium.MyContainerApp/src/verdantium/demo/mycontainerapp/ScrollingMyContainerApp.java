...
import verdantium.demo.mycontainerapp.help.ScrollingMyContainerAppHelp;
...
/**
* This demonstrates how to make a scrolling version of a {@link MyContainerApp}.
* <P>
* @author Thorn Green
*/
public class ScrollingMyContainerApp
	extends MyContainerApp
	implements Printable, PageSizeHandler {

	/**
	* The panel used to contain the non-scrolling parts of the container app.
	*/
	transient protected JPanel sizingPanel;

	/**
	* Constructs the scrolling container app.
	*/
	public ScrollingMyContainerApp() {
		super();
	...
	protected void arrangeLayoutScr() {
		scp =
			new UndoableScrollPane(
				...
				this,
				undoMgr);
		JPanel Panel2 = new ScrollingMyContainerAppPanel(this);
		sizingPanel = Panel2;
	...
	*/
	public static void displayVerdantiumHelp(VerdantiumComponent in) {
		ScrollingMyContainerAppHelp.run(in);
	}
	...
	*/
	public static void main(String argv[]) {
		...
		ScrollingMyContainerApp MyComp = new ScrollingMyContainerApp();
...
* @author Thorn Green
*/
class ScrollingMyContainerAppPanel
	extends JPanel
	implements Scrollable, ScrollableAlt {
	
	/**
	* The scrolling container app for which this component is the client.
	*/
	ScrollingMyContainerApp myCont = null;

	/**
	* Constructs the panel for a certain scrolling container app.
	* @param inc The app for which to construct the panel.
	*/
	public ScrollingMyContainerAppPanel(ScrollingMyContainerApp inc) {
		myCont = inc;
	}
