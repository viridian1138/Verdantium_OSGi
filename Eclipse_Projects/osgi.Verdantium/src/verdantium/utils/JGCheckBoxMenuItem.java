...
/**
* An implementation of a checkbox menu item with an item number and an object associated with it.
...
public class JGCheckBoxMenuItem extends JCheckBoxMenuItem {
	...
	/**
	* Constructs a checkbox menu item with a label, a state, a boolean value,
	* an integer item number, and an action listener.
	* @param Label The label for the menu item.
	* @param val The state of the checkbox.
	* @param InTag The item number associated with the menu item.
	* @param InL Action listener to receive button events.
	*/
	public JGCheckBoxMenuItem(String Label, boolean val, int InTag, ActionListener InL) {
		super(Label, val);
		Tag = InTag;
	...
	*/
	public JGCheckBoxMenuItem(String Label, boolean val, int InTag, ActionListener InL, Object InR) {
		super(Label, val);
		Tag = InTag;
		addActionListener(InL);
		RefCon = InR;
