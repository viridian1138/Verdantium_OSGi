package verdantium.standard.docprinter.help;
...
import verdantium.standard.docprinter.DocPrinter;
...
/**
 * Online help class for DocPrinter.
 * 
 * @author tgreen
 *
 */
public class DocPrinterHelp extends WrappingScrollingVerdantiumHelp {
	private DocPrinter MyCell = new DocPrinter();
	...
	public static void run(VerdantiumComponent in) {
		URL u = DocPrinterHelp.class.getResource("DocPrinterHelpPage.rtf");
		JComponent frm = null;
		if (in != null)
			frm = in.getGUI();
		DocPrinterHelp hlp = new DocPrinterHelp(u);
