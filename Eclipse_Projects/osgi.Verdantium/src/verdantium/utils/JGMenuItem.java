...
/**
* An implementation of a menu item with an item number and an object associated with it.
...
public class JGMenuItem extends JMenuItem {
	...
	/**
	* Constructs a menu item with a label, a state, a boolean value,
	...
	*/
	public JGMenuItem(String Label, int InTag, ActionListener InL) {
		super(Label);
		Tag = InTag;
	...
	*/
	public JGMenuItem(String Label, int InTag, ActionListener InL, Object InR) {
		super(Label);
		Tag = InTag;
		addActionListener(InL);
		RefCon = InR;
