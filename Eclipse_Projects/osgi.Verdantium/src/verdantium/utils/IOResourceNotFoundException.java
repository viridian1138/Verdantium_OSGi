...
/**
* An exception indicating that a particular resource was not found.
* Some future versions of Verdantium may have resources (i.e. a greater variety of borders)
* not supported by other (usually older) versions.
* 
* @author Thorn Green
*/
public class IOResourceNotFoundException extends IOException implements ThrowHandler {
	 ...
	 */
	public IOResourceNotFoundException(Throwable e) {
		super();
		wrap = e;
	}
	 ...
	 * @param e The throwable being wrapped.
	 */
	public IOResourceNotFoundException(String str, Throwable e) {
		super(str);
		wrap = e;
	}
