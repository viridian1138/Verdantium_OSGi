...
import verdantium.standard.help.ScrollingImageViewerHelp;
...
/**
* This demonstrates how to make a scrolling version of a {@link ImageViewer}.
* <P>
* @author Thorn Green
*/
public class ScrollingImageViewer
	extends ImageViewer
	...
	*/
	...
	/**
	* Sets up the layout managers for the scrolling image viewer.
	*/
	protected void arrangeLayoutScr() {
		scp =
			new UndoableScrollPane(
				...
				this,undoMgr);
		JPanel Panel2 = new ScrollingImageViewerPanel(this, this);
		sizingPanel = Panel2;
	...
	*/
	public static void displayVerdantiumHelp(VerdantiumComponent in) {
		ScrollingImageViewerHelp.run(in);
	}
	...
	*/
	public static void main(String argv[]) {
		...
		ScrollingImageViewer MyComp = new ScrollingImageViewer();
...
/**
* A panel that acts as an intermediary between the scroll pane and the enclosed image
* viewer GUI.
* 
* @author Thorn Green
*/
class ScrollingImageViewerPanel
	extends JPanel
	implements Scrollable, ScrollableAlt {
	
	/**
	* The imaging pane used in the editing component.
	*/
	JComponent myEdit = null;
	
	/**
	* The scrolling image viewer that uses the component.
	*/
	ScrollingImageViewer myImageViewer = null;

	/**
	 * Constructs the panel for a certain scrolling image viewer.
	 * @param in The imaging pane used in the editing component.
	 * @param inc The scrolling image viewer that uses the component.
	 */
	public ScrollingImageViewerPanel(JComponent in, ScrollingImageViewer inc) {
		myEdit = in;
		myImageViewer = inc;
	}
	...
	*/
	public Dimension getPreferredScrollableViewportSize() {
		Dimension d2 = myImageViewer.getPageSize();
		return (d2);
	}
