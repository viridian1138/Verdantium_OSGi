...
/**
* ApplicationBase provides a default base class for a simple application.
* 
* @author Thorn Green
*/
public abstract class ApplicationAdapter
	...
	*/
	...
	/**
	 * The undoable background state of the component.
	 */
	...
	/**
	 * The document page size of the component.
	 */
	transient protected PageSizeState pageSizeState = null;

	/**
	 * The optional scroll pane of the component.
	 */
	...
	*/
	...
	/**
	 * The multi-level undo manager for the component.
	 */
	...
	*/
	...
	/**
	 * Configures the various elements of the component to handle Ether Events.
	 */
	...
	public Object processObjEtherEvent(EtherEvent in, Object refcon)
		...
		if (getBkgnd() != null) {
			ret = getBkgnd().processObjEtherEvent(in, refcon);
			if (ret != EtherEvent.EVENT_NOT_HANDLED) {
				return (ret);
			}
		}
	...
	* @param e The input event to show the property editor.
	*/
	...
	*/
	...
	/**
	 * Gets the undoable background state of the component.
	 * @return The undoable background state of the component.
	 */
	...
	*/
	public Color getBackgroundColor() {
		return (getBkgnd().getBackgroundColor());
	}
	...
	*/
	...
	/**
	 * Handles a change to whether only the designer can edit the application.
	 */
	public void handleOnlyDesignerEditsChange() {
	}

	/**
	* Returns whether only the designer can edit the application.
	* @return Whether only the designer can edit the application.
	*/
	...
	/**
	* Provides an interface so that the document page size can be altered by a scrolling subclass.
	...
	*/
	...
	/**
	 * Handles a change to the component's document page size.
	 */
