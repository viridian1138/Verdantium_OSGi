...
import verdantium.core.FileWatcher;
...
/**
 * Online help class for FileWatcher.
 * 
 * @author tgreen
 *
 */
public class FileWatcherHelp extends WrappingScrollingVerdantiumHelp {
	private FileWatcher MyCell = new FileWatcher();
	...
	public static void run(VerdantiumComponent in) {
		URL u = FileWatcherHelp.class.getResource("FileWatcherHelpPage.rtf");
		JComponent frm = null;
		if (in != null)
			frm = in.getGUI();
		FileWatcherHelp hlp = new FileWatcherHelp(u);
		ProgramDirector.showPropertyEditor(hlp, frm, "File Watcher Help");
		hlp.parseElements();
	}
