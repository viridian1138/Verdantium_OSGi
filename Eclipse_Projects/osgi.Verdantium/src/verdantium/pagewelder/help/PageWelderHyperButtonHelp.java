package verdantium.pagewelder.help;
...
import verdantium.pagewelder.PageWelderHyperButton;
...
/**
 * Online help class for PageWelderHyperButton.
 * 
 * @author tgreen
 *
 */
public class PageWelderHyperButtonHelp extends WrappingScrollingVerdantiumHelp {
	
	private PageWelderHyperButton MyCell = new PageWelderHyperButton();
     ...
     */
	public PageWelderHyperButtonHelp(URL in) {
		super(in);
	...
	public static void run(VerdantiumComponent in) {
		URL u = PageWelderHyperButtonHelp.class.getResource("PageWelderHyperButtonHelpPage.rtf");
		JComponent frm = null;
		if (in != null)
			frm = in.getGUI();
		PageWelderHyperButtonHelp hlp = new PageWelderHyperButtonHelp(u);
		ProgramDirector.showPropertyEditor(hlp, frm, "Page Welder Hyper Button Help");
		hlp.parseElements();
	}
	...
	protected void dispatchAction(String txt) {
		if (txt.equals("comp")) {
			PageWelderHyperButton MyC = MyCell;
			insertComponent(MyC);
		}
