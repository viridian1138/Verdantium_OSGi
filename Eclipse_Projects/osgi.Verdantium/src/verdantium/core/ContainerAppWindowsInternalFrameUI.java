...
import verdantium.VerdantiumWindowsInternalFrameUI;
...
/**
* This class defines the Windows user interface for a {@link ContainerApp} document frame.
...
* @author Thorn Green
*/
public class ContainerAppWindowsInternalFrameUI
	extends VerdantiumWindowsInternalFrameUI {

	/**
	 * Constructor.
	 * @param b The internal frame onto which to apply the UI.
	 */
	public ContainerAppWindowsInternalFrameUI(JInternalFrame b) {
		super(b);
	}
	...
	*/
	public static ComponentUI createUI(JComponent c) {
		return new ContainerAppWindowsInternalFrameUI((JInternalFrame) c);
	}
