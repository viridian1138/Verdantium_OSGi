...
import verdantium.pagewelder.PageWelder;
...
/**
 * Online help class for PageWelder.
 * 
 * @author tgreen
 *
 */
public class PageWelderHelp extends WrappingScrollingVerdantiumHelp {
	
	private PageWelder MyCell = new PageWelder();
	...
	public static void run(VerdantiumComponent in) {
		URL u = PageWelderHelp.class.getResource("PageWelderHelpPage.rtf");
		JComponent frm = null;
		if (in != null)
			frm = in.getGUI();
		PageWelderHelp hlp = new PageWelderHelp(u);
		ProgramDirector.showPropertyEditor(hlp, frm, "Page Welder Help");
		hlp.parseElements();
	}
