package verdantium.demo.poseidon.help;
...
import verdantium.demo.poseidon.Poseidon;
import verdantium.demo.poseidon.PoseidonPropertyEditor;
...
/**
 * Online help class for Poseidon.
 * 
 * @author tgreen
 *
 */
public class PoseidonHelp extends WrappingScrollingVerdantiumHelp {
	private Poseidon MyCell = new Poseidon();
	...
	public PoseidonHelp(URL in) {
		...
		TopEdit =
			((PoseidonPropertyEditor) MyEdit0)
				.getTopColorCell()
	...
	public static void run(VerdantiumComponent in) {
		URL u = PoseidonHelp.class.getResource("PoseidonHelpPage.rtf");
		JComponent frm = null;
		if (in != null)
			frm = in.getGUI();
		PoseidonHelp hlp = new PoseidonHelp(u);
		ProgramDirector.showPropertyEditor(hlp, frm, "Poseidon Help");
		hlp.parseElements();
	}
