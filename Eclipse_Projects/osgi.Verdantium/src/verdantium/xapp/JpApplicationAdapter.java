...
* @author Thorn Green
*/
public abstract class JpApplicationAdapter
	extends JPanel
	...
	*/
	...
	/**
	 * Gets the background state of the component.
	 * @return The background state of the component.
	 */
