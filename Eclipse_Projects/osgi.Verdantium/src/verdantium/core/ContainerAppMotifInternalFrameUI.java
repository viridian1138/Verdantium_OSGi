...
import verdantium.VerdantiumMotifInternalFrameUI;
...
/**
* This class defines the Motif user interface for a {@link ContainerApp} document frame.
...
* @author Thorn Green
*/
public class ContainerAppMotifInternalFrameUI
	extends VerdantiumMotifInternalFrameUI {

	/**
	 * Constructor.
	 * @param b The internal frame onto which to apply the UI.
	 */
	public ContainerAppMotifInternalFrameUI(JInternalFrame b) {
		super(b);
	}
	...
	*/
	public static ComponentUI createUI(JComponent c) {
		return new ContainerAppMotifInternalFrameUI((JInternalFrame) c);
	}
